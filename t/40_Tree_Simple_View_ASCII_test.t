...
my $tree = Tree::Simple->new(Tree::Simple->ROOT)
                       ->addChildren(
                            Tree::Simple->new("Node Level: 1")
                                        ->addChildren(
                                            Tree::Simple->new("Node Level: 1.1"),
                                            Tree::Simple->new("Node Level: 1.2")
                                                        ->addChildren(
                                                            Tree::Simple->new("Node Level: 1.2.1"),
                                                            Tree::Simple->new("Node Level: 1.2.2")
                                                        ),
                                            Tree::Simple->new("Node Level: 1.3")
                                        ),
                            Tree::Simple->new("Node Level: 2")
                                        ->addChildren(
                                            Tree::Simple->new("Node Level: 2.1"),
                                            Tree::Simple->new("Node Level: 2.2")
                                        ),
                            Tree::Simple->new("Node Level: 3")
                                        ->addChildren(
                                            Tree::Simple->new("Node Level: 3.1")
                                                ->addChildren(
                                                    Tree::Simple->new("Node Level: 3.1.1"),
                                                    Tree::Simple->new("Node Level: 3.1.2")
                                                ),
                                        ),
                            Tree::Simple->new("Node Level: 4")
                                        ->addChildren(
                                            Tree::Simple->new("Node Level: 4.1")
                                        )
                       );
